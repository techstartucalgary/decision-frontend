      ...
      >
        ...
        >
          {polls.map((poll: any, index: any) => (
            ...
            //         }}
            //         fill={`${
            //           votedLocations.includes(polls.locationID)
            //             ? 'primary.100'
            //             : '#332244'
            //         }`}
            //         viewBox="0 0 24 24"
            ...
            //         value={
            //           polls.votes > 0
            //             ? (polls.votes / members[0].members.length) * 100
            //             : 0
            //         }
            //         colorScheme="primary"
            //         size="md"
            ...
            //   <AccordionPanel>
            //     <Heading fontSize="0.75rem" color="primary.100" mb="0.2rem">
            //       {polls.locationDetails.address}
            //     </Heading>
            //     <a
            //       href={polls.locationDetails.website}
            //       target="_blank"
            //       rel="noreferrer"
            //     >
            //       <Heading
            ...
            //       <HStack mr="auto">
            //         <Text fontSize="1rem" color="primary.100" mt="2.5px">
            //           {polls.locationDetails.rating}
            //         </Text>
            //         <StarRatings
            //           rating={polls.locationDetails.rating}
            //           starRatedColor="#FFDD99"
            //           starEmptyColor="#332244"
            //           numberOfStars={5}
            //           starDimension="1rem"
            ...
            //       </HStack>
            //       <Heading fontSize="0.75rem" color="primary.100" ml="auto">
            //         {polls.locationDetails.reviews} Reviews
            //       </Heading>
            //     </HStack>
            //     <HStack mt="1rem" overflowX="scroll">
            //       <AvatarGroup>
            //         {polls.members.map((index: string) => (
            //           <Avatar
            //             key={index}
            //             name={index}
            //             borderWidth="1px"
