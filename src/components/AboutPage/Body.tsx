...
const Body = () => {
    return (
        ...
        px="1rem">
            ...
            The purpose of this website is to help you and your friends plan a fun social gathering together! 
            <br></br>
            <br></br>
            Do you want to meet with a group of 
            ...
            website can provide the solution to all your worries. Simply enter in your budget, location, preferences, and we'll do all the leg work
            of finding places or events for you to go to. Once we compile a list of potential matches, all you need to do is send your friends our generated
            link, which will take them to a voting poll. Here, they vote for their pick from the list of the potential events or activites we compiled. The 
